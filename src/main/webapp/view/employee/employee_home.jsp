            ...
            <div class="bg-white p-2 shadow-sm rounded">
                ...
                <nav aria-label="Page navigation" class="mt-4">
                    <ul class="pagination justify-content-end">
                        <li class="page-item">
                            <a class="page-link" href="/employees?page=1" aria-label="Next">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                        <c:if test="${pageNum > 2}">
                            <li class="page-item"><a class="page-link"
                                                     href="/employees?page=${pageNum - 2}">${pageNum - 2}</a></li>
                        </c:if>
                        <c:if test="${pageNum > 1}">
                            <li class="page-item"><a class="page-link"
                                                     href="/employees?page=${pageNum - 1}">${pageNum - 1}</a></li>
                        </c:if>
                        <li class="page-item active"><a class="page-link"
                                                        href="/employees?page=${pageNum}">${pageNum}</a></li>
                        ...
                        <li class="page-item">
                            <a class="page-link" href="/employees?page=${lastPageNum}" aria-label="Next">
